    ...
    <header id="app" class="header">
     <NavApp />
      <div class="mid-title">
        ...
        >
          <p>CHARITIES AND NONPROFIT ORGANIZATIONS</p>
        </div>
      </div>
    </header>
